...
* 2023-06-20: install GOTM in conda environment (to do so separately, rerun [GOTM installation instructions](#building-and-installing-gotm-fabm) from the cmake command onward)
